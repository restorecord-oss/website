...
<head>
    ...
    <link rel="apple-touch-icon" href="https://cdn.restorecord.com/app-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="https://cdn.restorecord.com/app-assets/images/ico/favicon.ico">
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <div class="auth-footer-btn d-flex justify-content-center">
                                <a class="btn btn-facebook w-100" style="color: #fff; background-color: #5865F2;" href="javascript:newPopup('https://discord.com/api/oauth2/authorize?client_id=791106018175614988&redirect_uri=https://restorecord.com/api/discord&response_type=code&scope=identify&state=login');">Login With Discord
