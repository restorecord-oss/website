...
<section class="py-20 px-10">
    <h1 class="text-gray-900 font-bold text-5xl mb-5 text-center lg:text-8xl dark:text-gray-200">Terms of Service</h1>
    <div class="items-left justify-start text-left md:pl-24 md:pr-24 lg:pl-32 lg:pr-32">
        ...
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">These Terms of Use constitute a legally binding agreement
            ...
            OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
        <br>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Supplemental terms and conditions or documents that may
        ...
        <br>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">The information provided on the Site is not intended for
        ...
        <br>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">The Site is not tailored to comply with industry-specific
            ...
            Site. You may not use the Site in a way that would violate the Gramm-Leach-Bliley Act (GLBA).</p>
        <br>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">The Site is intended for users who are at least 13 years
        ...
        <p class="text-gray-500 lg:text-2xl dark:text-gray-100">2. INTELLECTUAL PROPERTY RIGHTS</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Unless otherwise indicated, the Site is our proprietary
            ...
            permission.</p>
        <br>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Provided that you are eligible to use the Site, you are
            ...
            all rights not expressly granted to you in and to the Site, the Content and the Marks.</p>
        <br>

        <p class="text-gray-500 lg:text-2xl dark:text-gray-100">3. USER REPRESENTATIONS</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">By using the Site, you represent and warrant that: (1)
            ...
            purpose; and (8) your use of the Site will not violate any applicable law or regulation.</p>
        <br>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">If you provide any information that is untrue,
            inaccurate, not current, or incomplete, we have the right to suspend or terminate your account and refuse
            any and all current or future use of the Site (or any portion thereof).</p>
        <br>

        <p class="text-gray-500 lg:text-2xl dark:text-gray-100">4. USER REGISTRATION</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">You may be required to register with the Site. You agree
        ...
        <p class="text-gray-500 lg:text-2xl dark:text-gray-100">5. PROHIBITED ACTIVITIES</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">You may not access or use the Site for any purpose other
        ...
        <br>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">As a user of the Site, you agree not to:</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Systematically retrieve data or other content from the
            Site to create or compile, directly or indirectly, a collection, compilation, database, or directory without
            written permission from us.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Trick, defraud, or mislead us and other users, especially
            in any attempt to learn sensitive account information such as user passwords.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Circumvent, disable, or otherwise interfere with
            security-related features of the Site, including features that prevent or restrict the use or copying of any
            Content or enforce limitations on the use of the Site and/or the Content contained therein.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Disparage, tarnish, or otherwise harm, in our opinion, us
            and/or the Site.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Use any information obtained from the Site in order to
            harass, abuse, or harm another person.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Make improper use of our support services or submit false
            reports of abuse or misconduct.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Use the Site in a manner inconsistent with any applicable
            laws or regulations.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Engage in unauthorized framing of or linking to the
            Site.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Upload or transmit (or attempt to upload or to transmit)
            ...
            or maintenance of the Site.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Engage in any automated use of the system, such as using
            scripts to send comments or messages, or using any data mining, robots, or similar data gathering and
            extraction tools.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Delete the copyright or other proprietary rights notice
            from any Content.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Attempt to impersonate another user or person or use the
        ...
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Upload or transmit (or attempt to upload or to transmit)
            ...
            similar devices (sometimes referred to as “spyware” or “passive collection mechanisms” or “pcms”).</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Interfere with, disrupt, or create an undue burden on the
            Site or the networks or services connected to the Site.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Harass, annoy, intimidate, or threaten any of our
            employees or agents engaged in providing any portion of the Site to you.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Attempt to bypass any measures of the Site designed to
            prevent or restrict access to the Site, or any portion of the Site.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Copy or adapt the Site's software, including but not
            limited to Flash, PHP, HTML, JavaScript, or other code.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Except as permitted by applicable law, decipher,
            decompile, disassemble, or reverse engineer any of the software comprising or in any way making up a part of
            the Site.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Except as may be the result of standard search engine or
            ...
            launching any unauthorized script or other software.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Use a buying agent or purchasing agent to make purchases
            on the Site.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Make any unauthorized use of the Site, including
            collecting usernames and/or email addresses of users by electronic or other means for the purpose of sending
            unsolicited email, or creating user accounts by automated means or under false pretenses.</p>
        ...
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Attempting to libel RestoreCord with the intent of
            hurting its reputation.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Making multiple accounts.</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">Sell or transfer of your members.</p>
        <br>

        <p class="text-gray-500 lg:text-2xl dark:text-gray-100">6. GUIDELINES FOR REVIEWS</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">We may provide you areas on the Site to leave reviews or
        ...
        <br>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">We may accept, reject, or remove reviews in our sole
            ...
            distribute all content relating to reviews.</p>
        <br>

        <p class="text-gray-500 lg:text-2xl dark:text-gray-100">7. SUBMISSIONS</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">You acknowledge and agree that any questions, comments,
        ...
        <p class="text-gray-500 lg:text-2xl dark:text-gray-100">8. THIRD-PARTY WEBSITE AND CONTENT</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">The Site may contain (or you may be sent via the Site)
        ...
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">
            <br>

        <p class="text-gray-500 lg:text-2xl dark:text-gray-100">9. SITE MANAGEMENT</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">We reserve the right, but not the obligation, to: (1)
        ...
        <p class="text-gray-500 lg:text-2xl dark:text-gray-100">11. TERM AND TERMINATION</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">These Terms of Use shall remain in full force and effect
            ...
            CONTENT OR INFORMATION THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION.</p>
        <br>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">If we terminate or suspend your account for any reason,
            ...
            without limitation pursuing civil, criminal, and injunctive redress.</p>
        <br>

        <p class="text-gray-500 lg:text-2xl dark:text-gray-100">12. MODIFICATIONS AND INTERRUPTIONS</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">We reserve the right to change, modify, or remove the
        ...
        <br>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">We cannot guarantee the Site will be available at all
        ...
        <br>
        <p class="text-gray-500 lg:text-2xl dark:text-gray-100">13. USER DATA</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">We will maintain certain data that you transmit to the
            ...
            against us arising from any such loss or corruption of such data.</p>
        <br>
        <p class="text-gray-500 lg:text-2xl dark:text-gray-100">14. MISCELLANEOUS</p>
        <p class="text-gray-700 lg:text-lg dark:text-gray-300">These Terms of Use and any policies or operating rules
            ...
            form of these Terms of Use and the lack of signing by the parties hereto to execute these Terms of Use.</p>
        <br>

        <p class="text-gray-500 lg:text-2xl dark:text-gray-100">15. CONTACT US</p>
