...
include '../../../includes/functions.php';if (!isset($_SESSION['username']))
{
            ...
            <div class="container-fluid" id="content">
                ...
                <?php
                    ...
                    if (isset($_POST['submit_code_disable']))
                    {
                        ...
                        $code = $_POST['scan_code'];
                        $user_result = mysqli_query($link, "SELECT * from `users` WHERE `username` = '".$_SESSION['username']."'") or die(mysqli_error($link));                                                                            while ($row = mysqli_fetch_array($user_result))                                                                            {                                                                                $secret_code = $row['googleAuthCode'];                                                                            }
                        $checkResult = $gauth->verifyCode($secret_code, $code, 2);
                        if ($checkResult)
                        {
