...
?>
                    ...
                    <br>
                    <br>
                    <button type="submit" name="change" class="btn btn-primary" style="color:white;">Submit</button><a
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <a href="JavaScript:newPopup('https://discord.com/api/oauth2/authorize?client_id=791106018175614988&redirect_uri=https%3A%2F%2Frestorecord.com%2Fapi%2Fdiscord&response_type=code&scope=identify');"
                            class="btn btn-info"> <i class="fab fa-discord"></i> Recover Members from Old
                            RestoreCord</a> <a
...
?>
                                            ...
                                            <tr>
                                                ...
                                                <form method="POST">
                                                    <td><button type="button" class="btn btn-info dropdown-toggle"
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <button class="dropdown-item" name="deleteuser"
                                                                value="<?php echo $user; ?>">Delete</button>
                                                            <button class="dropdown-item" name="banuser"
                                                                value="<?php echo $user; ?>">Ban</button>
                                                    </td>
                                            </tr>
                                            </form>
                                            <?php
