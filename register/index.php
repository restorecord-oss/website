...
if (isset($_POST['register']))
{
	...
	// check if $recaptcha is null then error
	if (is_null($recaptcha))
	{
		error("Please disable your VPN or set your DNS servers to 1.1.1.1");
		exit();
	}
		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w" method="post">
					...
					<h>All registered users are bound by the <a href="../terms" class="txt1" target="_blank">Terms of
							Service and Privacy Policy</a></h>
