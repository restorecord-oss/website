        ...
        <div class="container-fluid" id="content">
            <div class="row">
                <div class="col-12">
                    ...
                    <div id="search-username" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                         aria-hidden="true" style="display: none;">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header d-flex align-items-center">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="btn btn-danger waves-effect waves-light" name="searchusername">
                                        Search
                                    </button>
                                    </form>
                                </div>
            ...
            if (isset($_POST['editacc'])) {
                ...
                $totp = $row['twofactor'];
                ?>
                <div id="edit-key" class="modal show" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                        ...
                        <div class="modal-content">
                            <div class="modal-header d-flex align-items-center">
                                ...
                                <button type="button" onClick="window.location.href=window.location.href"
                                        class="close ml-auto" data-dismiss="modal" aria-hidden="true">×
                                </button>
                            </div>
                            <div class="modal-body">
                                <form method="post">
                            ...
                            <div class="modal-footer">
                                <button type="button" onClick="window.location.href=window.location.href"
                                        class="btn btn-default waves-effect" data-dismiss="modal">Close
                                </button>
...
<script src="https://cdn.restorecord.com/dashboard/assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
